...
export const AiClient = ({ projects, categorySlug }: Props) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="relative py-16 overflow-hidden">
        ...
        >
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/95 via-purple-500/90 to-indigo-500/95"></div>
        </div>
