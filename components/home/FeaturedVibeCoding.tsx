...
export default function FeaturedVibeCoding({ data }: Props) {
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Recent vibe coded applications we've built
            </p>
          </div>
          ...
          >
            <div className="flex gap-4 md:gap-6 py-4">
              {projects.map((project) => (
                <Link
                  key={project.id}
                  href={`/services/vibe-coding/${project.slug}`}
