...
// export default function FeaturedWebDevelopment() {
...
//       description: "Stunning portfolio showcase for a design agency",
//       image:
...
//       description: "Custom booking system with calendar integration",
//       image:
...
//     0,
//     projects.length * (itemWidth + gap) - (itemWidth * 3 + gap * 2)
//   );
...
//               Recent websites and web applications we've built
//             </p>
//           </div>
...
//                 <Link
//                   key={project.id}
//                   href={`/services/web-development/${project.slug}`}
...
export default function FeaturedWebDevelopment({ data }: Props) {
