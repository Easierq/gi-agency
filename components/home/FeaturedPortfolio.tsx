...
export default function FeaturedPortfolio({ data }: Props) {
    ...
    <section className="py-10 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/portfolio"
            className="group hidden md:flex items-center bg-green-600 p-2 px-5 rounded-full text-white font-semibold"
          >
            View All
                  ...
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden group hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                    <div className="relative h-48 overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-medium transition-colors flex items-center justify-center text-sm">
                          View Project
          ...
          {projects.length > 3 && (
            <>
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white hover:bg-green-50 disabled:opacity-50 disabled:cursor-not-allowed p-3 rounded-full shadow-lg transition-all z-10"
              >
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white hover:bg-green-50 disabled:opacity-50 disabled:cursor-not-allowed p-3 rounded-full shadow-lg transition-all z-10"
              >
        ...
        <div className="text-center mt-4 md:hidden">
          <Link
            href="/portfolio"
            className="inline-flex items-center border border-green-600 px-3 py-2 rounded-full text-green-600 hover:text-green-700 font-semibold"
          >
